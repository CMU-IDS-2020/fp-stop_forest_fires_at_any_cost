...
def causePlots(x):
    ...
    #Map Image
    col1.image(image_bank[x - 1980], width=1000)
    ...
    if human['BurnTime'].iloc[0] == 0 and natural['BurnTime'].iloc[0] == 0: 
        ...
        col2.plotly_chart(fig, width=500,height=200)
        ...
        fig2.update_layout(width=500,height=200)
        col2.plotly_chart(fig2, width=500,height=200)
